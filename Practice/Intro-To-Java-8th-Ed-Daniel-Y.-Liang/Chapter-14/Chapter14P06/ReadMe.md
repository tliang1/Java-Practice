# Comparable Rectangle by Tony Liang

Made using Java SE 12.

Displays two rectangles that are equal and two rectangles that are not equal.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestEqualRectangles.java.
2. Run the program.
