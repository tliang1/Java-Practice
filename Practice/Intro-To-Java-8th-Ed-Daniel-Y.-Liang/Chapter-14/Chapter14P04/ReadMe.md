...
Creates a House object and deep copy it. Displays both House objects and test if the deep copy was successful.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestDeepCopy.java.
2. Run the program.
