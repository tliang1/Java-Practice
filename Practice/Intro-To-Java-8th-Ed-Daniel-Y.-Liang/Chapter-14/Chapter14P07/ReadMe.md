# Octagon by Tony Liang

Made using Java SE 12.

Displays the area and perimeter of an octagon with side value of 5. Clone the octagon and compare the two octagons.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestOctagon.java.
2. Run the program.
