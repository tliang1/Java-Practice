...
Displays two circles that are equal and two circles that are not equal.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestEqualCircles.java.
2. Run the program.
