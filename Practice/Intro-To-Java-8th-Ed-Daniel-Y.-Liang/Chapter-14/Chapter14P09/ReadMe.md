# Largest Object by Tony Liang

Made using Java SE 12.

Displays the largest string, integer, and date of ten strings, integers, and dates.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click LargestObject.java.
2. Run the program.
