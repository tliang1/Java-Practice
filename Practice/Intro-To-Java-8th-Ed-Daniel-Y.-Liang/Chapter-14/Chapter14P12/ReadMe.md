# Divisible By Two Or Three by Tony Liang

Made using Java SE 12.

Displays the first ten numbers with 50 decimal digits that are divisible by two or three.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DivisibleByTwoOrThree.java.
2. Run the program.
