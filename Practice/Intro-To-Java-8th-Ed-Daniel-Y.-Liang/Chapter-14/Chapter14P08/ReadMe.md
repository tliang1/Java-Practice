# Sum Areas Of Geometric Objects by Tony Liang

Made using Java SE 12.

Displays the sum of all areas of two circles and two rectangles.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SumAreasOfGeometricObjects.java.
2. Run the program.
