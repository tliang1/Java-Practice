# Colorable by Tony Liang

Made using Java SE 12.

Displays how to color five geometric objects.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestHowToColor.java.
2. Run the program.
