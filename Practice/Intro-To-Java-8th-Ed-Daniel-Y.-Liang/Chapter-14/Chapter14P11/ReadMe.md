# Divisible By Five Or Six by Tony Liang

Made using Java SE 12.

Displays the first ten numbers that are greater than Long.MAX_VALUE and divisible by five or six.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DivisibleByFiveOrSix.java.
2. Run the program.
