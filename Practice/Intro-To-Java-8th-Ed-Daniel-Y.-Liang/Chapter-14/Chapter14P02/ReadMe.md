# Comparable Circle by Tony Liang

Made using Java SE 12.

Displays the circle with the larger area. The circle's creation date, color, whether it's filled or not, and radius are displayed.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click LargerOfTwoComparableCircles.java.
2. Run the program.
