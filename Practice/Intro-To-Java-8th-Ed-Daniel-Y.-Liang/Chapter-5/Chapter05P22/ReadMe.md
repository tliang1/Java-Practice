# Approximate Sqrt by Tony Liang

Made using Java SE 1.8.

Approximates the square root of the given positive number.

Approximate Sqrt Formula

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P22/images/instructions/approximate_sqrt_formula.png "Approximate Sqrt Formula"
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ApproximateSqrt.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click ApproximateSqrtTest.java.
2. Run the program.
