#Number Of Prime Numbers by Tony Liang

Made using Java SE 1.8.

Displays the number of prime numbers less than 10000.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click NumberOfPrimeNumbers.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click NumberOfPrimeNumbersTest.java.
2. Run the program.
