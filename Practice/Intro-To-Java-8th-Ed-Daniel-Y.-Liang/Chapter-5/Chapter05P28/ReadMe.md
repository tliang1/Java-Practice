#Mersenne Primes by Tony Liang

Made using Java SE 1.8.

Displays all Mersenne prime numbers with p less than or equal to 31.

Mersenne Prime Formula

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P28/images/instructions/mersenne_prime_formula.png "Mersenne Prime Formula"

If *n* is prime, *n* is a Mersenne prime number.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click MersennePrimes.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MersennePrimesTest.java.
2. Run the program.
