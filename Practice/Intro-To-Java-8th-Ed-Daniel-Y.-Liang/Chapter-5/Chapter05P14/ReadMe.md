...
[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P14/images/instructions/pi_summation_series.png "PI Summation Series"
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ComputeSeries.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click ComputeSeriesTest.java.
2. Run the program.
