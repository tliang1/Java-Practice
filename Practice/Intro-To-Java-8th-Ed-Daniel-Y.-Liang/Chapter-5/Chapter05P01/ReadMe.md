# Pentagonal Numbers by Tony Liang

Made using Java SE 1.8.

Displays the first hundred pentagonal numbers.

Pentagonal Number Formula

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P01/images/instructions/pentagonal_number_formula.png "Pentagonal Number Formula"
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click PentagonalNumbers.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click PentagonalNumbersTest.java.
2. Run the program.
