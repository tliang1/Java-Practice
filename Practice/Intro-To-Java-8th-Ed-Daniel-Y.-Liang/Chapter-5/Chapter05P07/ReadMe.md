#Future Investment Value Revised by Tony Liang

Made using Java SE 1.8.

Computes the future investment value for the years from 1 to 30 given the investment amount and the annual interest rate.

Future Investment Value Formula

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P07/images/instructions/future_investment_value_formula.png "Future Investment Value Formula"
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click FutureInvestmentValueRevised.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click FutureInvestmentValueRevisedTest.java.
2. Run the program.
