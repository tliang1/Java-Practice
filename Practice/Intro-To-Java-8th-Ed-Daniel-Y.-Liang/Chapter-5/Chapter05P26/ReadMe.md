#Palindrome Primes by Tony Liang

Made using Java SE 1.8.

Displays the first hundred palindromic prime numbers.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click PalindromePrimes.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click PalindromePrimesTest.java.
2. Run the program.
