# Sort Three Numbers by Tony Liang
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SortThreeNumbers.java.
2. Run the program.
...
# How To Use
1. Enter the three numbers each separated by a space. No commas.