#Twin Primes by Tony Liang

Made using Java SE 1.8.

Displays all prime number pairs that differ by 2 that are less than 1000.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TwinPrimes.java.
2. Run the program.
