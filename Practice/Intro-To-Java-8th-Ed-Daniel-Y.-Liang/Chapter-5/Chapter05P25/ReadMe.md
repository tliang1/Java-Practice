#Milliseconds Conversion by Tony Liang

Made using Java SE 1.8.

Converts milliseconds to hours, minutes, and seconds for 5500, 100000, and 555550000 milliseconds.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click MillisecondsConversion.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MillisecondsConversionTest.java.
2. Run the program.
