#Mean And Standard Deviation by Tony Liang

Made using Java SE 1.8.

Computes the mean and the standard deviation given ten numbers.

Mean And Standard Deviation Formulas

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P21/images/instructions/mean_and_standard_deviation_formulas.png "Mean And Standard Deviation Formulas"
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click MeanAndStandardDeviation.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MeanAndStandardDeviationTest.java.
2. Run the program.
...
#How To Use
1. Enter the ten numbers each separated by a space. No commas.