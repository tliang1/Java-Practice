# Print Calendar by Tony Liang

Made using Java SE 1.8.

Displays the calendar of the given month given the year and the month.

Zeller's Congruence Formula

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P34/images/instructions/zellers_congruence_formula.png "Zeller's Congruence Formula"
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click PrintCalendar.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click PrintCalendarTest.java.
2. Run the program.
