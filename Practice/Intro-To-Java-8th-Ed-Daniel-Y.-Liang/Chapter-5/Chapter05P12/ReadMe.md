# Display Characters by Tony Liang

Made using Java SE 1.8.

Displays the characters from '1' to 'Z'.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DisplayCharacters.java.
2. Run the program.
