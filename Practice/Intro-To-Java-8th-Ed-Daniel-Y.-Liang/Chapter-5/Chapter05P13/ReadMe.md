# Summation Series by Tony Liang
...
[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-5/Chapter05P13/images/instructions/summation_series.png "Summation Series"
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SummationSeries.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click SummationSeriesTest.java.
2. Run the program.
