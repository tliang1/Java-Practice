# Reversed Integer by Tony Liang

Made using Java SE 1.8.

Displays the reversal of the given integer.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ReversedInteger.java.
2. Run the program.
