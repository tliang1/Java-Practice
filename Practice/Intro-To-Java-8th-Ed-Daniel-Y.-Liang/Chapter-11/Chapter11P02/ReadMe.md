# Person, Student, Employee, Faculty, and Staff by Tony Liang

Made using Java SE 10.

Displays the class name and the person’s name for a Person, Student, Employee, Faculty, and Staff object.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestPeople.java.
2. Run the program.
