...
public class Triangle extends GeometricObject
{
	 ...
	 * <ul>
	 * 	<li>
	 * 		If any of the sides are less than or equal to 0.0, the side will default to 1.0.
	 * 	</li>
	 * </ul>
	 * 
	...
	{
		this.side1 = (side1 > 0.0) ? side1 : 1.0;
		this.side2 = (side2 > 0.0) ? side2 : 1.0;
		this.side3 = (side3 > 0.0) ? side3 : 1.0;
	}
