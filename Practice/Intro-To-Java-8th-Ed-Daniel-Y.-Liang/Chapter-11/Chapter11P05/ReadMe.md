# Course by Tony Liang

Made using Java SE 10.

This Course class uses an ArrayList instead of a String array for storing students.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestCourseWithArrayList.java.
2. Run the program.
