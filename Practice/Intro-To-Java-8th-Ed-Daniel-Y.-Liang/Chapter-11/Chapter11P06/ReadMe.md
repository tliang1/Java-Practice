# Using ArrayList by Tony Liang

Made using Java SE 10.

Displays the string representation of a Loan, Date, String, JFrame, and Circle object.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click UsingArrayList.java.
2. Run the program.
