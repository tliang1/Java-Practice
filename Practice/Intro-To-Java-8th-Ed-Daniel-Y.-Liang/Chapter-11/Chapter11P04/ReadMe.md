# MyStack by Tony Liang

Made using Java SE 10.

Displays five strings in reverse order.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyStack.java.
2. Run the program.
