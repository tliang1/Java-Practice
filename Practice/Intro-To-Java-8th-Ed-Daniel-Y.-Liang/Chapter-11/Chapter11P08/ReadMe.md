# Account And Transaction by Tony Liang

Made using Java SE 10.

Displays the account summary that shows the account holder's name, interest rate, balance, and all transactions.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestAccountAndTransaction.java.
2. Run the program.
