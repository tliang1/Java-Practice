# Account, SavingsAccount, and CheckingAccount by Tony Liang

Made using Java SE 10.

Displays the account ID, balance, annual interest rate, when the account was created, and the overdraft limit (CheckingAccount only) for an Account, SavingsAccount, and CheckingAccount object.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestAccounts.java.
2. Run the program.
