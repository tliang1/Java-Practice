# Rectangle by Tony Liang

Made using Java SE 10.

Displays the width, height, area, and perimeter of the two rectangles.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click Rectangle.java.
2. Run the program.
