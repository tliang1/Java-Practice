...
Displays the perimeter and area for three RegularPolygon objects.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestRegularPolygon.java.
2. Run the program.
