# Using Date by Tony Liang

Made using Java SE 10.

Displays the date and time for 10000, 100000, 10000000, 10000000, 100000000, 1000000000, 10000000000, and 100000000000 milliseconds elapsed since January 1, 1970, GMT.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click UsingDate.java.
2. Run the program.
