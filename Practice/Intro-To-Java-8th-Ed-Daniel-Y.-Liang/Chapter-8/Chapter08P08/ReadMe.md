...
Displays the description for two Fan objects.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestFan.java.
2. Run the program.
