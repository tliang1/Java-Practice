# Using Gregorian Calendar by Tony Liang

Made using Java SE 10.

Displays the current year, month, and day and the year, month, and day for 1234567898765 milliseconds elapsed since January 1, 1970, GMT.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click UsingGregorianCalendar.java.
2. Run the program.
