# Print Calendar Message Dialog by Tony Liang

Made using Java SE 10.

Displays the calendar of the given month in a message dialog box given the year and the month in input dialog boxes.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click PrintCalendarMessageDialog.java.
2. Run the program.
