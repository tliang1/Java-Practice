...
Displays the price-change percentage from the previous closing price of 4.5 to the current price of 4.35 of the stock whose symbol is JAVA and name is Sun Microsystems Inc.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click Stock.java.
2. Run the program.
