# Using Random by Tony Liang

Made using Java SE 10.

Displays the first 50 random integers between 0 and 100 using the Random object with seed 1000.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click UsingRandom.java.
2. Run the program.
