# Account by Tony Liang

Made using Java SE 10.

Displays the balance, monthly interest, and the date created of an account with ID 1122, a balance of $20,000, and an annual interest rate of 4.5% after withdrawing $2,500 and depositing $3,000.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestAccount.java.
2. Run the program.
