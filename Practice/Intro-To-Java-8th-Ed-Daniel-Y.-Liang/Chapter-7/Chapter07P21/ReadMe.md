# Sudoku by Tony Liang

Made using Java SE 1.8.

Sudoku solver that counts all possible solutions and displays up to two possible solutions to the Sudoku puzzle given the Sudoku puzzle.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click Sudoku.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click SudokuTest.java.
2. Run the program.
...
# How To Use
1. Enter the integers for the Sudoku puzzle each separated by a space. No commas. (Enter 0 for each empty cell if any).