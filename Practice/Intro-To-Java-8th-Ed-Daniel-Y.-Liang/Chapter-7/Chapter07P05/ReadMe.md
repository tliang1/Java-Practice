#Add Two Matrices by Tony Liang

Made using Java SE 1.8.

Computes the sum of the two 3 x 3 matrices given the two 3 x 3 matrices.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click AddTwoMatrices.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click AddTwoMatricesTest.java.
2. Run the program.
