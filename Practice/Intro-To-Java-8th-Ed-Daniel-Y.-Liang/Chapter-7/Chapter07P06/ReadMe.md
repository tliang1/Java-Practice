# Multiply Two Matrices by Tony Liang

Made using Java SE 1.8.

Computes the product of the two 3 x 3 matrices given the two 3 x 3 matrices.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click MultiplyTwoMatrices.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MultiplyTwoMatricesTest.java.
2. Run the program.
...
# How To Use
1. Enter the double values of the first matrix each separated by a space. No commas.
2. Enter the double values of the second matrix each separated by a space. No commas.