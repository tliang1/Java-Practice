#Sort Total Weekly Hours by Tony Liang

Made using Java SE 1.8.

Displays employees and their total weekly hours in decreasing order.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SortTotalWeeklyHours.java.
2. Run the program.
