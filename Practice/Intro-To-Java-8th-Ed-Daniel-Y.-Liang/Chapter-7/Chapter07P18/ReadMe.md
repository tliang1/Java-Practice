#Shuffling Rows by Tony Liang

Made using Java SE 1.8.

Shuffles the matrix below and displays the shuffled matrix.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ShufflingRows.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click ShufflingRowsTest.java.
2. Run the program.
