# Tic Tac Toe Board by Tony Liang

Made using Java SE 1.8.

Randomly fills a Tic Tac Toe board with 0s and 1s, displays the board, and displays the rows, columns, or diagonals with all 0s or 1s.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TicTacToeBoard.java.
2. Run the program.
