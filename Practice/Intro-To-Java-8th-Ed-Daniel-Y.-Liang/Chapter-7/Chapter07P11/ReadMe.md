#Nine Heads And Tails by Tony Liang

Made using Java SE 1.8.

Displays a state of a 3 x 3 matrix of heads and tails given the state.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click NineHeadsAndTails.java.
2. Run the program.
...
#How To Use
1. Enter a integer between 0 and 511 inclusive.