# Inverse Matrix by Tony Liang

Made using Java SE 1.8.

Displays the inverse matrix of the given 2 X 2 matrix.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click InverseMatrix.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click InverseMatrixTest.java.
2. Run the program.
...
# How To Use
1. Enter the numbers for the 2 X 2 matrix each separated by a space. No commas.