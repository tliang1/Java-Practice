...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TicTacToe.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click TicTacToeTest.java.
2. Run the program.
...
1. For each player's turn:
	1. Enter the row for O or X.
	2. Enter the column for O or X.