# Sum Of Numbers In A Matrix by Tony Liang

Made using Java SE 1.8.

Computes the sum of all integers in a 4 x 4 matrix given the integers of the 4 x 4 matrix.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SumOfNumbersInAMatrix.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click SumOfNumbersInAMatrixTest.java.
2. Run the program.
