# MyDate by Tony Liang

Made using Java SE 10.

Displays the hours, minutes, and seconds of two MyDate objects.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyDate.java.
2. Run the program.
