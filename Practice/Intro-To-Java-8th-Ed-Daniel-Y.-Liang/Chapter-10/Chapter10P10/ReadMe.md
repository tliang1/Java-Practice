# Guess Date by Tony Liang

Made using Java SE 10.

Guesses the date of the month of your birthday.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestGuessDate.java.
2. Run the program.
