# My Point by Tony Liang

Made using Java SE 10.

Displays the distance between (0, 0) and (10, 30.5).
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyPoint.java.
2. Run the program.
