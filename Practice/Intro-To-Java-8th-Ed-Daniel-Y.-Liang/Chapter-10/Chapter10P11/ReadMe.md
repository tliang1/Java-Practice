# Circle2D by Tony Liang

Made using Java SE 10.

Displays the area and perimeter of a circle and checks if a point is inside this circle, a circle is inside this circle, and a circle is overlapping this circle.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestCircle2D.java.
2. Run the program.
