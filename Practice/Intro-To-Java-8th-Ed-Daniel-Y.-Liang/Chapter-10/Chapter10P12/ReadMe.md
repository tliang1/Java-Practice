# MyRectangle2D by Tony Liang

Made using Java SE 10.

Displays the area and perimeter of a rectangle and checks if a point is inside this rectangle, a rectangle is inside this rectangle, and a rectangle is overlapping this rectangle.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyRectangle2D.java.
2. Run the program.
