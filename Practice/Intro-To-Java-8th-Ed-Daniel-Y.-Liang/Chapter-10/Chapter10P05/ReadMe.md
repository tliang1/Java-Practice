# Prime Factors by Tony Liang

Made using Java SE 10.

Displays the smallest factors of a positive integer in decreasing order.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click PrimeFactors.java.
2. Run the program.
