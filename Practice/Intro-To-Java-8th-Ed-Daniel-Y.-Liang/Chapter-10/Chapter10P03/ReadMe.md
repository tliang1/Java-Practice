# My Integer by Tony Liang

Made using Java SE 10.

My own implementation of the simplified custom Integer class's constructor and methods-get, isEven, isOdd, isPrime, equals, and parseInt.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyInteger.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MyIntegerTest.java.
2. Run the program.
