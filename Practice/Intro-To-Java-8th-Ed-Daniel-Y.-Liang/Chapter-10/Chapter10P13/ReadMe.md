# Triangle2D by Tony Liang

Made using Java SE 10.

Displays the area and perimeter of a triangle and checks if a point is inside this triangle, a triangle is inside this triangle, and a triangle is overlapping this triangle.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestTriangle2D.java.
2. Run the program.
