...
Displays all leap years from 2001 to 2100 inclusive.
...
8. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click LeapYears.java.
9. Run the program.