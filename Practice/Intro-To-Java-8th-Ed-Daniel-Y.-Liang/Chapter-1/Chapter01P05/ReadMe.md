#Compute Expression by Tony Liang
...
8. In the Package Explorer tab, drop down the project folder, the src folder, and the package and select ComputeExpression.java.
9. Run the program.