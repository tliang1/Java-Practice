# Hex To Decimal Conversion by Tony Liang

Made using Java SE 12.

Converts the given hex string into a decimal number.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click HexToDecimalConversion.java.
2. Run the program.
