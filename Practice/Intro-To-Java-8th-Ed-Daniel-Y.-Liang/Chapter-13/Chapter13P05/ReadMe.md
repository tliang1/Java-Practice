# Illegal Triangle Exception by Tony Liang

Made using Java SE 12.

Displays the area, the perimeter, and the color of a triangle and if the triangle is filled given the three sides.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestTriangle.java.
2. Run the program.
