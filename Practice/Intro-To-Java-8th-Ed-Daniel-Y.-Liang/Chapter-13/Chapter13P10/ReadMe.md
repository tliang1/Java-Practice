# Handle Out Of Memory Error by Tony Liang

Made using Java SE 12.

A program that causes the JVM to throw an OutOfMemoryError and catches and handles this error.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click HandleOutOfMemoryError.java.
2. Run the program.
