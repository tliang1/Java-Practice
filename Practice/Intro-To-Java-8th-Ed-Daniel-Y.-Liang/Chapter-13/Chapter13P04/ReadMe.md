# Loan With Exception by Tony Liang

Made using Java SE 12.

Displays the date the loan was created, the monthly payment, and the total payment given the yearly interest rate, the number of years, and the loan amount.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestLoanWithException.java.
2. Run the program.
...
# How To Use
1. Enter yearly interest rate (e.g., 8.25 for 8.25%).
