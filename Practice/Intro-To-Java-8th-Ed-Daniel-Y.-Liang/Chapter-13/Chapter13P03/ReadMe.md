# Display Array Element by Tony Liang

Made using Java SE 12.

Displays the element value given the index of the array.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DisplayArrayElement.java.
2. Run the program.
...
# How To Use
1. Enter the index of the array.