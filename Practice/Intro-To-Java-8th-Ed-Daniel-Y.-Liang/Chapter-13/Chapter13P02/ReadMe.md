# Sum Of Two Integers by Tony Liang

Made using Java SE 12.

Displays the sum of the two given integers.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SumOfTwoIntegers.java.
2. Run the program.
