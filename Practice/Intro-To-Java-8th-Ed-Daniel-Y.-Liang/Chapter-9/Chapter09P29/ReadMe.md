# New String Split Method by Tony Liang

Made using Java SE 10.

Implements a method similar to the String class's split method that returns not only the substrings, but also the delimiter(s).
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click NewStringSplitMethod.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click NewStringSplitMethodTest.java.
2. Run the program.
...
# How To Use
1. Enter the string.
2. Enter the delimiter or regular expression.