# Common Prefix by Tony Liang

Made using Java SE 10.

Displays the common prefix of the two given strings.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click CommonPrefix.java.
2. Run the program.
