# Sort Characters In A String by Tony Liang

Made using Java SE 10.

Displays the sorted string given the string.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SortCharactersInAString.java.
2. Run the program.
