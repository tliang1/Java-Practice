# MyString1 by Tony Liang

Made using Java SE 10.

My own implementation of the String class's constructor and methods-charAt, length, substring, toLowerCase, equals, and valueOf.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyString1.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MyString1Test.java.
2. Run the program.
