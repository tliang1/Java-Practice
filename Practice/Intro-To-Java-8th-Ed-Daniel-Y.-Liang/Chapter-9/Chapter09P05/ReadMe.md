# Digit Occurrences by Tony Liang

Made using Java SE 10.

Displays the number of occurrences of each digit in the string.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DigitOccurrences.java.
2. Run the program.
