# Writing Reading Data by Tony Liang

Made using Java SE 10.

Creates a file named Exercise9_19.txt and writes 100 random integers into it. Then, the file is read and the sorted integers are displayed.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click WritingReadingData.java.
2. Run the program.
