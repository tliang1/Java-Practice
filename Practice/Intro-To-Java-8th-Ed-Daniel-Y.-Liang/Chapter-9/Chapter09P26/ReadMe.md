# MyStringBuilder1 by Tony Liang

Made using Java SE 10.

My own implementation of the StringBuilder class's constructor and methods-append, length, charAt, toLowerCase, substring, and toString.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyStringBuilder1.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MyStringBuilder1Test.java.
2. Run the program.
