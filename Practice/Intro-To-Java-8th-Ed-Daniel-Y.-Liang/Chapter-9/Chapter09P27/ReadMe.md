# MyStringBuilder2 by Tony Liang

Made using Java SE 10.

My own implementation of the StringBuilder class's constructors and methods-insert, reverse, substring, and toUpperCase.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyStringBuilder2.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MyStringBuilder2Test.java.
2. Run the program.
