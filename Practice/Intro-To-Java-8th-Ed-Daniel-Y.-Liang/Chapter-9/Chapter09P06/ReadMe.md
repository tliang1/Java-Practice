# Count Letters In A String by Tony Liang
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click CountLettersInAString.java.
2. Run the program.
