# Anagrams by Tony Liang

Made using Java SE 10.

Checks if the two given words are anagrams.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click Anagrams.java.
2. Run the program.
