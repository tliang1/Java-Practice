# Binary To Hex by Tony Liang

Made using Java SE 10.

Displays the hexadecimal number given the binary number.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click BinaryToHex.java.
2. Run the program.
