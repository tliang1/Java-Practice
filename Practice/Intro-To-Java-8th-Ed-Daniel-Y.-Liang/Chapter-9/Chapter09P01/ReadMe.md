# Checking SSN by Tony Liang

Made using Java SE 10.

Checks if the social security number is entered in the format DDD-DD-DDDD where D is a digit.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click CheckingSSN.java.
2. Run the program.
