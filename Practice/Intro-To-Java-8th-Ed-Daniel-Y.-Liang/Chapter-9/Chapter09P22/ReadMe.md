# Guess Capitals by Tony Liang

Made using Java SE 10.

A game for the player to guess the capital of a state. Generates ten random states questions. After answering all the questions, the total correct guesses will be displayed.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click GuessCapitals.java.
2. Run the program.
...
1. For every question:
	1. Enter the capital of the state.
	2. Click OK to check the answer.
	3. Click OK to move on to the next question.