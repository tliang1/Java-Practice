# Decimal To Binary by Tony Liang

Made using Java SE 10.

Displays the binary number given the decimal number.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DecimalToBinary.java.
2. Run the program.
