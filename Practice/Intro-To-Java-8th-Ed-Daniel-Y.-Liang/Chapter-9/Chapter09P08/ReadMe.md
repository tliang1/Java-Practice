# Binary String To Decimal Integer by Tony Liang

Made using Java SE 10.

Displays the decimal integer given the binary string.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click BinaryStringToDecimalInteger.java.
2. Run the program.
