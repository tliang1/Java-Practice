# MyCharacter by Tony Liang

Made using Java SE 10.

My own implementation of the Character class.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click TestMyCharacter.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click MyCharacterTest.java.
2. Run the program.
