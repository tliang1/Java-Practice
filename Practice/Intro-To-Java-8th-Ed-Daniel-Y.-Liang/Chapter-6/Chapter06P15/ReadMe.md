#Eliminating Duplicates by Tony Liang

Made using Java SE 1.8.

Displays the distinct integers given the ten integers.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click EliminatingDuplicates.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click EliminatingDuplicatesTest.java.
2. Run the program.
...
#How To Use
1. Enter the ten positive integers each separated by a space. No commas.