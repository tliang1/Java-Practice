#Averaging An Array by Tony Liang

Made using Java SE 1.8.

Computes the average given the ten double values.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click AveragingAnArray.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click AveragingAnArrayTest.java.
2. Run the program.
