# Identical Arrays by Tony Liang

Made using Java SE 1.8.

Checks if two lists of integers are identical given each lists' size and their integers.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click IdenticalArrays.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click IdenticalArraysTest.java.
2. Run the program.
