#Execution Time by Tony Liang

Made using Java SE 1.8.

Displays the execution times in milliseconds for linear search and binary search on an array of 100000 random integers using a random key.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ExecutionTime.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click ExecutionTimeTest.java.
2. Run the program.
