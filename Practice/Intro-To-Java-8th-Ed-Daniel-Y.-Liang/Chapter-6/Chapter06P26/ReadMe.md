# Strictly Identical Arrays by Tony Liang

Made using Java SE 1.8.

Checks if two lists of integers are strictly identical given each lists' size and their integers.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click StrictlyIdenticalArrays.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click StrictlyIdenticalArraysTest.java.
2. Run the program.
...
# How To Use
1. Enter the first list's size and its integers each separated by a space. No commas.
2. Enter the second list's size and its integers each separated by a space. No commas.