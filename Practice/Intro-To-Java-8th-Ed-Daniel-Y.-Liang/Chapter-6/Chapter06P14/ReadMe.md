#Compute GCD by Tony Liang

Made using Java SE 1.8.

Computes the greatest common divisor given the five integers.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click ComputeGCD.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click ComputeGCDTest.java.
2. Run the program.
...
#How To Use
1. Enter the five integers each separated by a space. No commas.