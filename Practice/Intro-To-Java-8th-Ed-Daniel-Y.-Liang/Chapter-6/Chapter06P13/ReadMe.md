# Random Number Chooser by Tony Liang

Made using Java SE 1.8.

Generates a random integer between 1 and 54 inclusive with the option to exclude some integers from the random number generation.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click RandomNumberChooser.java.
2. Run the program.
