#Smallest Element Index by Tony Liang

Made using Java SE 1.8.

Displays the smallest index of the minimum double value given the ten double values.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SmallestElementIndex.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click SmallestElementIndexTest.java.
2. Run the program.
