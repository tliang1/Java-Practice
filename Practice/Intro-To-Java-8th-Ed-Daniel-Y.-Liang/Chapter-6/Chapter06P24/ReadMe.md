#Coupon Collector Problem by Tony Liang

Made using Java SE 1.8.

Counts the number of picks needed to get four cards each of different suit and displays the cards.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click CouponCollectorProblem.java.
2. Run the program.
