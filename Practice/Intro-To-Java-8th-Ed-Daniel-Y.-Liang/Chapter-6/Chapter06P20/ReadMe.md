#Eight Queens by Tony Liang

Made using Java SE 1.8.

Displays a solution to the classic Eight Queens puzzle.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click EightQueens.java.
2. Run the program.
