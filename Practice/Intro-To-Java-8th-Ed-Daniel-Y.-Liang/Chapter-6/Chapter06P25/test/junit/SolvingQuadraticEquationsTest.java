...
{
	double[][] quadraticEquationsCoefficients = { { }, { 5.1 }, { 2.1, -4.9 }, { 0.0, 0.0, 8.3 }, { 1.0, 3, 1 }, 
			{ 1, 2.0, 1 }, { 1, 2, 3 }, { 6.6, 9.3, 2.4, 8.9 }, { -20.9, 19.17, 0.0 }, { 0.0, -2.5, 12.2 }, 
			{ 5.4, 0.0, 0.0 }, { 3.4, 0.0, 14.23 }, { 7.7, 5.23, 0.0 } };
