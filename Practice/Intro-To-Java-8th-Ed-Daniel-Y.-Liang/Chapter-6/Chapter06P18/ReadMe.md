#Bubble Sort by Tony Liang

Made using Java SE 1.8.

Sorts the seven double values using bubble sort given the seven double values.
...
####Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click BubbleSort.java.
2. Run the program.

####Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click BubbleSortTest.java.
2. Run the program.
...
#How To Use
1. Enter the seven double values each separated by a space. No commas.