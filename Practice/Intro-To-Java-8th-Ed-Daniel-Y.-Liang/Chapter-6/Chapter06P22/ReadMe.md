# Multiple Eight Queens by Tony Liang

Made using Java SE 1.8.

Counts and displays all possible solutions to the classic Eight Queens puzzle.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click MultipleEightQueens.java.
2. Run the program.
