# Selection Sort by Tony Liang

Made using Java SE 1.8.

Sorts the ten double values using selection sort given the ten double values.
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click SelectionSort.java.
2. Run the program.

#### Run JUnit Tests
1. In the Package Explorer tab, drop down the project folder, the test folder, and the package and click SelectionSortTest.java.
2. Run the program.
