# Displaying Labels by Tony Liang

Made using Java SE 10.

Displays four labels.

Four Labels

![alt text][logo]

[logo]: https://github.com/tliang1/Java-Practice/raw/master/Practice/Intro-To-Java-8th-Ed-Daniel-Y.-Liang/Chapter-12/Chapter12P05/images/instructions/four_labels.png "Four Labels"
...
#### Run Program
1. In the Package Explorer tab, drop down the project folder, the src folder, and the package and click DisplayingLabels.java.
2. Run the program.
